...
public class product {
	...
	public String getItems() {
		...
		while(rs.next())
		{
		 ...
		 + "<td>" + rs.getString(3) + "</td>"+ "<td><input id=\"btnEdit\" type=\"button\" name=\"btnEdit\"param=\"" + rs.getString(1) + "\" value=\"Edit\"</td>"+ "<td>" + "<input id=\"btnRemove\" type=\"button\"name=\"btnRemove\" param=\"" + rs.getString(1) + "\"value=\"Remove\"</td></tr>";
		 }
		}
		 else
		 ...
		 public String updateAnItem(String itemId, String itmName, String itmDesc) {
			 String res = null;
			 String sql = null;
			 Connection con = null;
			 Statement st = null;
			 ...
			 con = DBConnection.createConnection(); 
			 st = con.createStatement(); 
			 sql = "update items set descitems = '"+itmDesc+"' where itemid = '"+ itmName +"' ";
			 st.executeUpdate(sql);
		 ...
		 public String deleteAnItem(String itmName) {
			 String res = null;
			 String sql = null;
			 Connection con = null;
			 Statement st = null;
			 ...
			 con = DBConnection.createConnection(); 
			 st = con.createStatement(); 
			 sql = "delete from items where nameitems = '"+itmName+"'";
			 st.executeUpdate(sql);
